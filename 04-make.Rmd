...
nothing to the left of `article.md` line in Figure \@ref(fig:workflowdiagram). The
start of the sample `article-markdown.md` file is shown in Listing \@ref(lst:yamlheader). The bit at the top is metadata, which pandoc
