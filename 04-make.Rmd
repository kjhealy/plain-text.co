...
## What extension (e.g. md, markdown, mdown) is being used for markdown files
MEXT = md
...
## `make html`. Read the rule as "When making the html file, run this pandoc 
## command if the .md file has changed."
%.html:	%.md
