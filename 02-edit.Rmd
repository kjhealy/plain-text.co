...
The excerpt shown in @lst:markdown shows a few of the most
...
Pandoc filter named [`pandoc-crossref`](https://github.com/lierdakil/pandoc-crossref)
...
knitr::include_graphics("figures/emacs-ess-2016.png")
```
