...
[Sublime Text](https://www.sublimetext.com) instead of Emacs (I return
to these alternatives below). Similarly, when doing data analysis with
R, you may just want to use the
[RStudio environment](http://rstudio.com). You will do fine if you go
